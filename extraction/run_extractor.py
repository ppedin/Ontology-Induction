...
from extraction.extractors.pragmarag_prompt.medical_extractor import MedicalExtractor
...
if __name__ == "__main__":
    ...
    extractor = MedicalExtractor(
        ...
        output_path=Path(
            "C:/Users/paolo/Desktop/Ontology-Induction/outputs/exp_7_13/graphragbench_medical/pragmarag_prompt/extraction/"
        ),
        max_workers=6,
        batch_size=3,
        thinking_budget=512,
